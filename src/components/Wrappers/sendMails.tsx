...
export default function SendMail({ visibility }: Props) {
  ...
  return (
    ...
    >
      {userEmail === "diptanshumahish2016@gmail.com" ? (
        <div
        ...
        >
          <div>
            ...
            <div>
              Make sure you are using this bulk mailing feature only when
              needed,
            </div>
            {/* main work area  */}
            <div className="p-4 flex flex-col gap-4">
              ...
              <div>
                <div className="text-xl">
                  4. Enter the richly formatted html
                </div>
                <textarea
                  name="html"
        ...
        <div className="flex flex-col gap-2">
          <div className="text-white">
            Mass mailing service will be available soon
          </div>
          <button
            className="bg-white p-1 pl-2 pr-2 rounded-md "
            onClick={() => {
              store.dispatch(updateMail());
            }}
          >
